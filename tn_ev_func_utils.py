"""
I'm not the author of these codes, they are from the tweetynet github codes.
I also used their related work here for using threshodling segmentation as baseline: https://github.com/NickleDave/evfuncs/blob/fb4c71b845b3d0274848ab134b4c587578401775/src/evfuncs/evfuncs.py#L333
"""
            ...
            if line == "":  # if End Of File
                ...
                try:
                    ...
                    try:
                        ...
                        raise ValueError(
                            "Couldn't convert following value for ADFREQ in .rec file {} to an integer: {}".format(
                                filename, sample_freq_float))
